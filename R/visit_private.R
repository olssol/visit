...
#'
#' Plot densities of DLT and response rate based on prior knowledge
#'
#' @rdname plot.VTPRIOR
#'
#' @param x A class \code{VTPRIOR} list generated by \code{\link{vtPriorPar}}
#' @param model 0: parametric
#' @param n ?
#' @param draw.levels ?
#' @param adjust ?
#' @param ... ?
...
#' Summary of Priors
#'
#' Summary of DLT and response rate based on prior knowledge
#' Doesn't work
#'
#' @rdname summary.VTPRIOR
#'
#' @param object ?
#' @param qs ?
#' @param model 0:PARA; 1:PARA+; 2:PARA SINGLEALPHA; 3:PARA+ SINGLEALPHA
#' @param n ?
#' @param ... ?
#'
#' @method summary VTPRIOR
#'
